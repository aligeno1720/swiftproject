...
def login():
    transactionreference = input("TRANSACTION REFERENCE No: ")
    time.sleep(2)
    swiftinputreference = input("SWIFT INPUT REFERENCE No: ")
...
typewrite(
    ...
    "BANK ADDRESS   : SAMANHUDI ST NO. 44, PASAR BARU, SAWAR BESAR, CENTRAL JAKARTA,JAKARTA 10710, INDONESIA",
    "ACCOUNT NAME   : PT. SUMBER AMARTA JAYA",
)

time.sleep(2)

typewrite(
    "AMOUNT         : €101,000,000.00 (ONE HUNDRED ONE MILLION EUROS)",
    "SENDER BIC     : DEUTDEDB660",
    "BRECEIVER BIC  : BRINIDJA",
    "ACCOUNT NAME   : PT. SUMBER AMARTA JAYA",
)
